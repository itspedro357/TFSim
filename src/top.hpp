...
public:
    ...
    void rob_mode_blp(int n_bits, int history_bits, int counter_bits, unsigned int nadd, unsigned int nmul, unsigned int nload,
                  std::map<std::string,int> instruct_time, std::vector<std::string> instruct_queue,
